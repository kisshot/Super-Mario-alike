...
def check_keydown_events(event, ai_settings, screen, mario):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        # mario_shadow.moving_right = True

    elif event.key == pygame.K_LEFT:
        # 向左移动Mario
        mario.moving_left = True
        # mario_shadow.moving_left = True
    elif event.key == pygame.K_w:
        # 马里奥跳跃
        mario.moving_up = True
        # mario_shadow.moving_up = True
...
def check_keyup_events(event, mario):
    ...
    if event.key == pygame.K_RIGHT:
        ...
        # mario_shadow.moving_right = False
    elif event.key == pygame.K_LEFT:
        mario.moving_left = False
        # mario_shadow.moving_left = False
    if event.key == pygame.K_w:
        mario.moving_up = False
        mario.moving_down = True
        # mario_shadow.moving_up = False
        # mario_shadow.moving_down = True
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.type == pygame.KEYDOWN:
                ...
                # mario_shadow.facing_right = True
