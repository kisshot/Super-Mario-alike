...
def handle_state(mario, enemies):
    # spritecollideany
    # spritecollide
    if pygame.sprite.groupcollide(mario, enemies, False, True):
        # enemies.empty()  #'''这句话很关键'''
        print('THEY ARE TOGETHER+++++++++++++++++++++++++++++++++++++')


def update_screen(ai_settings, screen, mario, enemy, enemy_shadow, centerx):
    """更新屏幕上的图像，并切换到新屏幕"""
    # 背景图片
